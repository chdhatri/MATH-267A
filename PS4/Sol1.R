##1)
scan("/users/ssarma/Dropbox1/Dropbox/MATH 267/Assignments/PS4/wonderPets.txt",
     what=character(),sep=",")
...
## 2)
(caffeine <- read.table("/users/ssarma/Dropbox1/Dropbox/MATH 267/Notes/caffeine.txt",
                        header = TRUE))
# the column names are preceededby X's as they are numeric values, 
